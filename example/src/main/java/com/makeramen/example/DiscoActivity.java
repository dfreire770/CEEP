...
public class DiscoActivity extends Activity //implements ActionBar.OnNavigationListener {
{
    //funciona de manera similar al main
...
*/
    if (savedInstanceState == null) {
      getFragmentManager().beginTransaction()
          .replace(android.R.id.content, new DiscoFragment())
          .commit();
    }
